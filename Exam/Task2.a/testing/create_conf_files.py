    ...
    for test_case in all_test_cases:
        ...
        for index in range(len(test_case) - 1):
            ...
            if string_version is None:
                string_version = '""'
            inputs += template_for_each_single_test_case_input.format(key=list(key_value_dict.keys())[index], value=string_version)
        ...
        if test_case[-1][0][0] is None:
            ...
            for expected_result_tuple, row_index in test_case[-1][0]:
                ...
                outputs += template_for_each_single_test_case_output.format(output_column_name=output_column_name, output_value=expected_result_tuple, row_index=row_index)
            outputs = template_single_test_result_list_output.format(test_case_output=outputs[:-2])
        out += inputs + outputs
    return out[:-2]
...
if __name__ == '__main__':
    print('Starting...')
    parse_dmn('/home/administrator/Desktop/Knowledge-Engineering-and-Business-Intelligence/Exam/Task2.a/wine_choice_system_v2_using_camunda_7.dmn',
              '/home/administrator/Desktop/Knowledge-Engineering-and-Business-Intelligence/Exam/Task2.a/documents',
              '/home/administrator/Desktop/Knowledge-Engineering-and-Business-Intelligence/Exam/Task2.a/documents/mapping.txt')
    print('Done!')
